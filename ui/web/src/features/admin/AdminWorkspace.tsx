...
export interface AdminWorkspaceProps { readonly client?: MembershipClient; readonly readOnly?: boolean; }

export function AdminWorkspace({ client = new HttpMembershipClient(), readOnly = false }: AdminWorkspaceProps) {
