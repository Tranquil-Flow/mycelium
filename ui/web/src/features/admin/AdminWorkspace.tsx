...
export interface AdminWorkspaceProps { readonly client?: MembershipClient; }

export function AdminWorkspace({ client = new HttpMembershipClient() }: AdminWorkspaceProps) {
