...
export const m22ReleaseFixture: M22ReleaseEvidence = Object.freeze({
  ...
  reviewer: Object.freeze({ bundle_version: 'external-mac-reviewer-m22-1', bundle_manifest_digest: `sha256:${'f'.repeat(64)}`, preflight_idempotent: true, surrogate_verified: true, external_network: true, assigned_stage: true, inference_completed: true, negative_case_verified: true }),
