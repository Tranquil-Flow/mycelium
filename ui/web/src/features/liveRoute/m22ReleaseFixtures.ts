...
export const m22ReleaseFixture: M22ReleaseEvidence = Object.freeze({
  ...
  services: Object.freeze({ package_count: 3, roles: Object.freeze(['seed','node','supervisor']), platform_classes: Object.freeze(['launchd','systemd']), continuous_renewal: true, bounded_restart: true, foreground_route_restart_verified: true, restart_verified: true, coordinator_restart_verified: true, log_rotation: true, graceful_drain: true }),
