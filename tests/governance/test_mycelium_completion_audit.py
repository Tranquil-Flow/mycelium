...
from scripts.mycelium_completion_audit import DEFAULT_CHECKLIST, PLAN_PATH, audit
...
def test_current_mycelium_completion_checklist_is_closed_and_truthful() -> None:
    result = audit(ROOT)
    assert result == {
        "checked_gates": 13,
        "findings": [],
