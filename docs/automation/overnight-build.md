...
| 2026-07-18T03:02Z | Main/A1 `f2bc55b`; quiescent A2 `f534a1b9`, B `d8a58518`, C `279810be`, mobile `ffffafba` re-inspected; no newer source commits | `this commit` | P4 | Forged registered peers reporting another placement or unrelated edge failed status assertions; TCP provenance GREEN; broad regression caught and GREENed subclass-compatible dispatch | Focused Router 20 + regression 2; full Python 678 passed, 2 skipped, 117 subtests with 1 inherited missing-plan failure; canonical 648 passed, 2 skipped, 95 subtests with the same failure; compile/diff and `route_ready` scan green | Registered source identity now reaches in-process and local loopback-TCP failure validation. Same-process evidence only; no transport authentication, physical host, iroh Router dispatch, or `route_ready` claim. Next: bind token-event origin to the final locked-hop owner. |
| 2026-07-18T03:25Z | Main/A1 `f2bc55b6`; quiescent dirty A2/B/C at `dc9ca4c5` re-inspected; no source imported, local tranche atop overnight `f434b704` | `this commit` | P4 | Registered non-final peer token forgery reached the client through in-process and TCP paths; 2 focused RED then GREEN | Final focused 17; wire/contracts 28 + 7 subtests; audit 11; full Python 680 passed, 2 skipped, 1 inherited missing-plan test deselected, 117 subtests; compile/diff and `route_ready` scan green | Client-visible tokens now require the final locked-hop owner under local registered sender binding. No authenticated remote identity, physical host, execution parity, durability, or `route_ready` claim. Next: bind prefill-completion provenance before decode transition. |
| 2026-07-18T03:56Z | Main/A1 `f2bc55b6`; quiescent dirty A2/B/C at `dc9ca4c5` re-inspected; no source imported | `4bb6525` | P4 | Registered non-final peer prefill completion advanced LOCKED to DECODING through in-process and TCP paths; 2 focused RED then GREEN | Focused chunk/transport 12; Python 3.14+MLX full 681 passed, 2 skipped, 117 subtests with 2 inherited missing-doc failures; local two-process qualified with `route_ready=false`; UI/integrity surfaces absent | Prefill completion now requires final locked-hop ownership under local registered sender binding. No authenticated remote identity, physical host, progressive-prefill MVP claim, durability, or `route_ready` claim. Next: bind any remaining mutating receive path, then authenticated remote transport. |
| 2026-07-18T04:33Z | Main/A1 `f2bc55b6`; quiescent dirty A2/B/C at `dc9ca4c5` re-inspected; no source imported | `2e5da25` | P4 | Registered non-final peer manifest lock advanced pending PREFILL through in-process and TCP dispatch; 2 focused RED then GREEN | Focused Router 14; Python 3.14+MLX full 684 passed, 2 skipped, 117 subtests with 1 inherited missing-plan failure; supplementary 684 green; compile/diff and `route_ready` scan green | Entry manifest-lock transition now requires final locked-hop ownership under local registered sender binding. No authenticated remote identity, participant-registration hardening, physical host, durability, or `route_ready` claim. Next: bind participant manifest registration and hop ingress, then authenticated iroh dispatch. |
| 2026-07-18T05:07Z | Main/A1 `f2bc55b6`; quiescent A2/B/C at `dc9ca4c5` inspected; no source imported | `this commit` | P4 | Non-final peer registered a forged participant path in-process and over TCP; 2 focused RED then GREEN | Focused 2 + Router 26; Python 3.14+MLX 684 passed, 2 skipped, 1 inherited plan test deselected, 117 subtests; local two-process qualified with `route_ready=false`; compile/diff scan green | Participant registration now requires final locked-hop ownership under local registered sender binding. No authenticated remote identity, physical host, durability, or `route_ready` claim. Next: bind hop ingress to the expected previous-hop owner, then authenticated iroh dispatch. |
| 2026-07-18T05:28Z | Main/A1 `f2bc55b6`; quiescent A2/B/C at `dc9ca4c5` inspected; no source imported | `this commit` | P4 | Registered final peer forged hop 1 as another placement's logical source in-process and over TCP; 2 focused RED then GREEN; honest hop-zero replay regression found and resolved | Focused Router 31; contracts 37 + 7 subtests and audit 11; Python 3.14+MLX 685 passed, 2 skipped, 117 subtests with 2 inherited missing-doc failures; supplementary 685 green; local two-process qualified with `route_ready=false`; compile/diff green | Later-hop ingress now requires the transport sender to own the previous locked placement. Local registered sender binding only; no authenticated remote identity, physical host, durability, or `route_ready` claim. Next: bind hop-zero ingress/progressive prefill, then authenticated iroh dispatch. |
| 2026-07-18T06:03Z | Main `f2bc55b6` active; quiescent A1 `f2bc55b6` and dirty A2/B/C `dc9ca4c5` inspected; no source imported | `this commit` | P4 | Registered non-entry peer executed locked decode hop zero in-process and over TCP; cached duplicate also bypassed provenance; 3 focused RED then GREEN | Focused 3 + related Router 40; Python 3.14+MLX 689 passed, 2 skipped, 117 subtests with 1 inherited missing-plan failure; supplementary green; contract audit 11; local two-process qualified with `route_ready=false`; compile/diff green | Locked decode hop zero now requires the first-admitted local transport entry, including cached replays. Local registered sender binding only; no authenticated remote identity, progressive-prefill provenance, physical host, durability, or `route_ready` claim. Next: bind progressive-prefill ingress to observed previous-hop owners, then authenticated iroh dispatch. |
| 2026-07-18T06:48Z | Main/A1 `f2bc55b6`; quiescent dirty A2/B/C at `dc9ca4c5` re-inspected; no source imported, local tranche atop overnight `a33844b` | `this commit` | P4 | Forged route-building hop 1 reached DECODING in-process and over TCP; cached replay from the wrong peer returned FORWARDED; 3 focused RED then GREEN | Focused 3 + related 39; Router 181 passed, 42 subtests with 1 inherited missing-plan failure; full Python 692 passed, 2 skipped, 117 subtests with the same failure; supplementary 692 green; local two-process qualified with 3 activation frames and `route_ready=false`; compile/diff green | Route-building hops after hop zero now require the observed sender to own the previous selected placement, including cached replays. Local registered sender binding only; no authenticated remote identity, progressive-prefill/KV MVP claim, physical host, durability, or `route_ready` claim. Next: bind route-building hop zero to the admitted entry, then authenticated iroh dispatch. |
